...
<body bgcolor="#0066FF" >
   ...
   <table width="795" height="800" align="center" bgcolor="#3366FF">
 ...
 ?> 
   ...
   <td><input type="file" name="product_img1"/><br><img src="product_images/<?php echo $p_img1; ?>" width="70" height="70" /></td>
   
   </tr>
   
   <tr>
   <td align="right"><b>Product Image2</b></td>
   <td><input type="file" name="product_img2"/><br><img src="product_images/<?php echo $p_img2; ?>" width="70" height="70" /></td>
   
   </tr>
   
   <tr>
   <td align="right"><b>Product Image3</b></td>
   <td><input type="file" name="product_img3"/><br><img src="product_images/<?php echo $p_img3; ?>" width="70" height="70" /></td>
