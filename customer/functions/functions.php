...
$db = mysqli_connect("localhost","root","","slietstore");
		 ...
		 if(!isset($_GET['edit_account'])){
		  if(!isset($_GET['change_pass'])){
		    if(!isset($_GET['delete_account'])){
				...
				$get_orders = "select * from customers_orders where customer_id='$customer_id' AND order_status='pending'";
				...
				if($count_orders>0){
					...
					<h2>Dear $customer_name this serives is available only on <b>SLIET LONGOWAL(148106)</b></h2>
					<h3>Please check your orders  details <a href='my_account.php?my_orders'>Click Here</a></h3><br>
					...
					<div style='padding:10px;'>
					<h1 style='color:red;'>Important!</h1>
					<h2>Dear $customer_name this serives is available only on <b>SLIET LONGOWAL(148106)</h2>
					<h3>Please can check your orders history<a href='my_account.php?my_orders'>Click Here</a></h3><br>
...
//Getting the total price form the cart
