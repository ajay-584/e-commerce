             ...
             <table width="800" align="center" height="400" bgcolor="#FFFFFF" >
               ...
               <tr>
                ...
                <tr>
                  ...
                  <td><input type="text" name="c_pin"  value="<?php echo $pin; ?>"></td>
               </tr>
                              
               <tr align="center">
                  <td colspan="2"><input type="submit" name="update_account" value="Update Now" /></td>
               </tr>
...
<?php
    ...
    if(isset($_POST['update_account'])){
	   ...
	   $update_c = "UPDATE `customers` SET `customer_name`='$c_name',`customer_email`='$c_email',`customer_pass`='$c_pass',`customer_city`='$c_city',`customer_contact`='$c_contact',`customer_address`='$c_address',`customer_pin`='$c_pin' WHERE `customer_id`='$update_id'";
